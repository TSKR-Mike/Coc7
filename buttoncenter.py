            ...
            if callbacks != None:
                ...
                if self.firstLocX != None:
                    self.objectButton = pygwidgets.TextButton(window, (self.buttonX, self.buttonY), self.text[self.b],
                                                              ...
                                                              , self.upcolor, self.overcolor, self.downcolor, fontName=self.font, fontSize=self.font_size)
